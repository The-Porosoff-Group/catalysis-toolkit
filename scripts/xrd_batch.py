...
def _compact_phase(sample: str, stats: Dict[str, Any], phase: Dict[str, Any]) -> Dict[str, Any]:
    return {
        ...
        "weight_fraction_basis": phase.get("weight_fraction_basis"),
        "weight_fraction_note": phase.get("weight_fraction_note"),
        "diffraction_area_fraction_pct": phase.get("integrated_phase_fraction_%"),
        "integrated_phase_fraction_pct": phase.get("integrated_phase_fraction_%"),
        "integrated_phase_fraction_method": phase.get("integrated_phase_fraction_method"),
        "integrated_phase_fraction_note": phase.get("integrated_phase_fraction_note"),
